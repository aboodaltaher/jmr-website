...
const products: Product[] = [
  ...
  },
  {
    ...
    brand: "ecobee",
    tag: "Best Value",
    image: "/images/ecobee-smart-thermostat-lite-dubai.jpg",
    alt: "ecobee Smart Thermostat Lite for apartments in Dubai",
    fit: "cover",
    desc: "Smart cooling made affordable. All the essentials — app control, scheduling and eco savings — in a simple, reliable thermostat ideal for apartments and rentals.",
    chips: ["App Control", "Scheduling", "Entry-Level"],
    features: [
      "Full smartphone app control",
      "Custom & smart scheduling",
      "eco+ energy savings",
      "Simple, fuss-free setup",
    ],
    details: [
      { label: "Key Features", value: "Wi-Fi app control, scheduling, eco+ savings, essential smart features." },
      { label: "Benefits", value: "Lowest-cost entry into smart cooling with genuine savings." },
